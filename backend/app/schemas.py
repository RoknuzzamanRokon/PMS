...
class AvailableDateRateItem(BaseModel):
    rate_id: str


class AvailableDateRoomItem(BaseModel):
    room_id: str
    rates: list[AvailableDateRateItem]
...
class AvailabilityProperty(BaseModel):
    id: str
