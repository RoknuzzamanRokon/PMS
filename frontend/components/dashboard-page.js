...
export function DashboardPage() {
  ...
  return (
    ...
    >
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
          <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm dark:border-slate-700 dark:bg-slate-800/70">
              ...
              <p className="text-slate-500 dark:text-slate-400">`/api/v1/dashboard/overview`</p>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-700">
              ...
              <div className="space-y-3">
                {overview.top_rate_plans.map((item) => (
                  <div key={item.rate_id} className="rounded-lg bg-slate-50 p-3 dark:bg-slate-800/70">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
          ...
          <div className="mt-5 space-y-3">
            {overview.payments.map((payment) => (
              <div key={payment.payment_id} className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/70">
          ...
          <div className="mt-5 space-y-3">
            {overview.departures.length ? (
              overview.departures.map((departure) => (
                <div key={departure.booking_id} className="rounded-xl bg-slate-50 p-4 dark:bg-slate-800/70">
                  <p className="font-semibold text-slate-900 dark:text-slate-100">
      ...
      <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
        ...
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/70">
          <label className="relative min-w-[260px] flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm text-slate-700 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
            />
          </label>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Showing <span className="font-bold text-slate-900 dark:text-slate-100">{filteredProperties.length}</span> of{" "}
            <span className="font-bold text-slate-900 dark:text-slate-100">{properties.length}</span> properties
          </p>
        </div>
        ...
        {propertiesLoading ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
            <div className="hidden bg-slate-50 px-5 py-3 text-xs font-bold uppercase tracking-[0.18em] text-slate-500 dark:bg-slate-800/70 dark:text-slate-400 md:grid md:grid-cols-[1fr_1.3fr_0.8fr_0.9fr_auto] md:gap-4">
            ...
            <div className="divide-y divide-slate-200 dark:divide-slate-700">
              {filteredProperties.map((property) => (
                <article
                  ...
                  className="grid gap-4 px-5 py-4 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/60 md:grid-cols-[1fr_1.3fr_0.8fr_0.9fr_auto] md:items-center"
                >
                  <div>
                  ...
                  <div className="flex justify-start md:justify-end">
                    <button className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-primary hover:text-primary dark:border-slate-700 dark:text-slate-300">
